{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "import pandas as pd\n",
    "df1 = pd.read_csv(\"CALL_NDELIVERY_07MONTH.csv\")"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "  </tbody>\n",
       "</table>\n",
       "<p>100336 rows × 8 columns</p>\n",
       "</div>"
      ],
      "text/plain": [
       "              일자 요일  시간대           업종     시도   시군구     읍면동  통화건수\n",
       "0       20190701  월    0  음식점-족발/보쌈전문  서울특별시  영등포구   문래동3가     5\n",
       "1       20190701  월    0  음식점-족발/보쌈전문  서울특별시   서초구     양재동     5\n",
       "2       20190701  월    0  음식점-족발/보쌈전문  서울특별시   성동구   성수동2가     5\n",
       "3       20190701  월    0  음식점-족발/보쌈전문  서울특별시    중구     신당동     5\n",
       "4       20190701  월    0  음식점-족발/보쌈전문  서울특별시   강북구     미아동     5\n",
       "5       20190701  월    0     음식점-중국음식  서울특별시   강서구    내발산동     5\n",
       "6       20190701  월    0     음식점-중국음식  서울특별시   강남구     역삼동     5\n",
       "7       20190701  월    0     음식점-중국음식  서울특별시   송파구     송파동     5\n",
       "8       20190701  월    0     음식점-중국음식  서울특별시   은평구     불광동     5\n",
       "9       20190701  월    0     음식점-중국음식  서울특별시    중구  남대문로5가     5\n",
       "10      20190701  월    0     음식점-중국음식  서울특별시   중랑구     면목동     5\n",
       "11      20190701  월    0     음식점-중국음식  서울특별시   관악구     봉천동     5\n",
       "12      20190701  월    0     음식점-중국음식  서울특별시   강남구     논현동     5\n",
       "13      20190701  월    0     음식점-중국음식  서울특별시  동대문구     제기동     5\n",
       "14      20190701  월    0     음식점-중국음식  서울특별시   마포구     상암동     5\n",
       "15      20190701  월    0     음식점-중국음식  서울특별시   강북구     미아동     5\n",
       "16      20190701  월    0     음식점-중국음식  서울특별시  서대문구     연희동     5\n",
       "17      20190701  월    0     음식점-중국음식  서울특별시   성동구   성수동2가     5\n",
       "18      20190701  월    0     음식점-중국음식  서울특별시   강서구     가양동     5\n",
       "19      20190701  월    0           치킨  서울특별시   서초구     방배동     5\n",
       "20      20190701  월    0           치킨  서울특별시   강남구     개포동     5\n",
       "21      20190701  월    0           치킨  서울특별시   강남구     논현동     5\n",
       "22      20190701  월    0           치킨  서울특별시   강남구     삼성동     5\n",
       "23      20190701  월    0           치킨  서울특별시   강남구     역삼동     5\n",
       "24      20190701  월    0           치킨  서울특별시   강동구     상일동     5\n",
       "25      20190701  월    0           치킨  서울특별시   강동구     성내동     5\n",
       "26      20190701  월    0           치킨  서울특별시   강북구     미아동     5\n",
       "27      20190701  월    0           치킨  서울특별시   강북구      번동     5\n",
       "28      20190701  월    0           치킨  서울특별시   강서구    내발산동     7\n",
       "29      20190701  월    0           치킨  서울특별시   강서구     등촌동     5\n",
       "...          ... ..  ...          ...    ...   ...     ...   ...\n",
       "100306  20190731  수   23           치킨  서울특별시   송파구     송파동    19\n",
       "100307  20190731  수   23           치킨  서울특별시   양천구     신정동     5\n",
       "100308  20190731  수   23           치킨  서울특별시  영등포구   문래동3가    16\n",
       "100309  20190731  수   23           치킨  서울특별시  영등포구    여의도동     5\n",
       "19      20190701    0           치킨     5\n",
       "20      20190701    0           치킨     5\n",
       "21      20190701    0           치킨     5\n",
       "22      20190701    0           치킨     5\n",
       ...
       "29      20190701    0           치킨     5\n",
       "...          ...  ...          ...   ...\n",
       "100306  20190731   23           치킨    19\n",
       "100307  20190731   23           치킨     5\n",
       "100308  20190731   23           치킨    16\n",
       "100309  20190731   23           치킨     5\n",
       "100310  20190731   23           치킨     5\n",
       "100311  20190731   23           치킨    12\n",
       "100312  20190731   23           치킨    30\n",
       "100313  20190731   23           치킨     5\n",
       "100314  20190731   23           치킨     9\n",
       "100315  20190731   23           치킨     5\n",
       "100316  20190731   23           치킨     5\n",
       "100317  20190731   23           치킨    16\n",
       "100318  20190731   23           치킨     5\n",
       "100319  20190731   23           치킨     8\n",
       "100320  20190731   23           피자     5\n",
       "100321  20190731   23           피자     5\n",
       "100322  20190731   23           피자     5\n",
       "100323  20190731   23           피자     5\n",
       "100324  20190731   23           피자     5\n",
       "100325  20190731   23           피자     5\n",
       "100326  20190731   23           피자     8\n",
       "100327  20190731   23           피자     5\n",
       "100328  20190731   23           피자     5\n",
       "100329  20190731   23           피자     5\n",
       "100330  20190731   23           피자     5\n",
       "100331  20190731   23           피자     5\n",
       "100332  20190731   23           피자     5\n",
       "100333  20190731   23           피자     5\n",
       "100334  20190731   23           피자     5\n",
       "100335  20190731   23           피자     5\n",
       "\n",
       "[100336 rows x 4 columns]"
      ]
     },
     "execution_count": 29,
     "metadata": {},
  ...
  },
  {
   ...
   "source": [
    "import pandas as pd\n",
    "df2 = pd.read_csv(\"CALL_NDELIVERY_08MONTH.csv\")"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "  </tbody>\n",
       "</table>\n",
       "<p>99746 rows × 8 columns</p>\n",
       "</div>"
      ],
      "text/plain": [
       "             일자 요일  시간대           업종     시도   시군구     읍면동  통화건수\n",
       "0      20190801  목    0  음식점-족발/보쌈전문  서울특별시   강남구     개포동     5\n",
       "1      20190801  목    0  음식점-족발/보쌈전문  서울특별시   서초구     방배동     5\n",
       "2      20190801  목    0  음식점-족발/보쌈전문  서울특별시   노원구     상계동     5\n",
       "3      20190801  목    0  음식점-족발/보쌈전문  서울특별시   용산구   한강로2가     5\n",
       "4      20190801  목    0  음식점-족발/보쌈전문  서울특별시   서초구     양재동     5\n",
       "5      20190801  목    0  음식점-족발/보쌈전문  서울특별시   강동구     성내동     5\n",
       "6      20190801  목    0  음식점-족발/보쌈전문  서울특별시    중구     신당동     5\n",
       "7      20190801  목    0  음식점-족발/보쌈전문  서울특별시   강북구     미아동     5\n",
       "8      20190801  목    0     음식점-중국음식  서울특별시   강남구     삼성동     5\n",
       "9      20190801  목    0     음식점-중국음식  서울특별시   강서구    내발산동     5\n",
       "10     20190801  목    0     음식점-중국음식  서울특별시   강서구     등촌동     5\n",
       "11     20190801  목    0     음식점-중국음식  서울특별시   강서구     화곡동     5\n",
       "12     20190801  목    0     음식점-중국음식  서울특별시   관악구     봉천동     5\n",
       "13     20190801  목    0     음식점-중국음식  서울특별시   관악구     신림동     5\n",
       "99738  20190831  토   23           피자  서울특별시   동작구     사당동     5\n",
       "99739  20190831  토   23           피자  서울특별시  서대문구     연희동     5\n",
       "99740  20190831  토   23           피자  서울특별시   서초구     방배동     5\n",
       "99741  20190831  토   23           피자  서울특별시   성동구   성수동2가     5\n",
       "99742  20190831  토   23           피자  서울특별시   성동구     옥수동     5\n",
       "99743  20190831  토   23           피자  서울특별시   은평구     불광동     5\n",
       "99744  20190831  토   23           피자  서울특별시    중구     신당동     5\n",
       "99745  20190831  토   23           피자  서울특별시   중랑구     면목동     5\n",
       "\n",
       "[99746 rows x 8 columns]"
      ]
     },
     "execution_count": 31,
     "metadata": {},
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "  </tbody>\n",
       "</table>\n",
       "<p>99746 rows × 4 columns</p>\n",
       "</div>"
      ],
      "text/plain": [
       "             일자  시간대           업종  통화건수\n",
       "0      20190801    0  음식점-족발/보쌈전문     5\n",
       "1      20190801    0  음식점-족발/보쌈전문     5\n",
       "2      20190801    0  음식점-족발/보쌈전문     5\n",
       "3      20190801    0  음식점-족발/보쌈전문     5\n",
       "4      20190801    0  음식점-족발/보쌈전문     5\n",
       "5      20190801    0  음식점-족발/보쌈전문     5\n",
       "6      20190801    0  음식점-족발/보쌈전문     5\n",
       "7      20190801    0  음식점-족발/보쌈전문     5\n",
       "8      20190801    0     음식점-중국음식     5\n",
       "9      20190801    0     음식점-중국음식     5\n",
       "10     20190801    0     음식점-중국음식     5\n",
       "11     20190801    0     음식점-중국음식     5\n",
       "12     20190801    0     음식점-중국음식     5\n",
       "13     20190801    0     음식점-중국음식     5\n",
       "14     20190801    0     음식점-중국음식     5\n",
       "15     20190801    0     음식점-중국음식     5\n",
       "16     20190801    0     음식점-중국음식     9\n",
       "17     20190801    0     음식점-중국음식     5\n",
       "18     20190801    0     음식점-중국음식     5\n",
       "19     20190801    0     음식점-중국음식     5\n",
       "20     20190801    0     음식점-중국음식     5\n",
       "21     20190801    0     음식점-중국음식     5\n",
       "22     20190801    0     음식점-중국음식     5\n",
       "23     20190801    0     음식점-중국음식     5\n",
       "24     20190801    0     음식점-중국음식     5\n",
       "25     20190801    0     음식점-중국음식     5\n",
       "26     20190801    0     음식점-중국음식     5\n",
       "27     20190801    0     음식점-중국음식     5\n",
       "28     20190801    0     음식점-중국음식     5\n",
       "29     20190801    0     음식점-중국음식     5\n",
       "...         ...  ...          ...   ...\n",
       "99716  20190831   23           치킨     5\n",
       "99717  20190831   23           치킨     5\n",
       "99718  20190831   23           치킨    16\n",
       "99719  20190831   23           치킨     5\n",
       "99720  20190831   23           치킨    11\n",
       "99721  20190831   23           치킨     5\n",
       "99722  20190831   23           치킨     5\n",
       "99723  20190831   23           치킨     6\n",
       "99724  20190831   23           치킨     5\n",
       "99725  20190831   23           치킨     5\n",
       "99726  20190831   23           치킨    17\n",
       "99727  20190831   23           치킨     5\n",
       "99728  20190831   23           치킨     9\n",
       "99729  20190831   23           피자     5\n",
       "99730  20190831   23           피자     5\n",
       "99731  20190831   23           피자     5\n",
       "99732  20190831   23           피자     5\n",
       "99733  20190831   23           피자     5\n",
       "99734  20190831   23           피자     5\n",
       "99735  20190831   23           피자     5\n",
       "99736  20190831   23           피자     5\n",
       "99737  20190831   23           피자     5\n",
       "99738  20190831   23           피자     5\n",
       "99739  20190831   23           피자     5\n",
       "99740  20190831   23           피자     5\n",
       "99741  20190831   23           피자     5\n",
       "99742  20190831   23           피자     5\n",
       "99743  20190831   23           피자     5\n",
       "99744  20190831   23           피자     5\n",
       "99745  20190831   23           피자     5\n",
       "\n",
       "[99746 rows x 4 columns]"
      ]
     },
     "execution_count": 32,
     "metadata": {},
  ...
  },
  {
   ...
   "source": [
    "import pandas as pd\n",
    "df3 = pd.read_csv(\"CALL_NDELIVERY_09MONTH.csv\")"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "5      20190901  일    0  음식점-족발/보쌈전문  서울특별시   중랑구     면목동     5\n",
       "6      20190901  일    0  음식점-족발/보쌈전문  서울특별시  서대문구     대현동     5\n",
       "7      20190901  일    0  음식점-족발/보쌈전문  서울특별시   노원구     공릉동     5\n",
       "8      20190901  일    0  음식점-족발/보쌈전문  서울특별시   강동구     상일동     5\n",
       "9      20190901  일    0  음식점-족발/보쌈전문  서울특별시   강동구     성내동     6\n",
       "10     20190901  일    0  음식점-족발/보쌈전문  서울특별시   관악구     봉천동     5\n",
       "11     20190901  일    0  음식점-족발/보쌈전문  서울특별시  서대문구     홍제동     5\n",
       "12     20190901  일    0  음식점-족발/보쌈전문  서울특별시   강남구     논현동     5\n",
       "13     20190901  일    0  음식점-족발/보쌈전문  서울특별시   노원구     상계동     5\n",
       "14     20190901  일    0     음식점-중국음식  서울특별시   관악구     봉천동     5\n",
       "15     20190901  일    0     음식점-중국음식  서울특별시    중구     수하동     5\n",
       "16     20190901  일    0     음식점-중국음식  서울특별시    중구     신당동     5\n",
       "17     20190901  일    0     음식점-중국음식  서울특별시   노원구     공릉동     5\n",
       "18     20190901  일    0     음식점-중국음식  서울특별시  동대문구     제기동     5\n",
       "19     20190901  일    0     음식점-중국음식  서울특별시   마포구     합정동     5\n",
       "20     20190901  일    0     음식점-중국음식  서울특별시  서대문구     연희동     5\n",
       "21     20190901  일    0     음식점-중국음식  서울특별시   성동구   성수동2가     5\n",
       "22     20190901  일    0     음식점-중국음식  서울특별시   송파구     송파동     5\n",
       "23     20190901  일    0     음식점-중국음식  서울특별시   양천구     신정동     5\n",
       "24     20190901  일    0     음식점-중국음식  서울특별시   중랑구     면목동     5\n",
       "25     20190901  일    0     음식점-중국음식  서울특별시   은평구     불광동     5\n",
       "26     20190901  일    0     음식점-중국음식  서울특별시   종로구     연지동     5\n",
       "27     20190901  일    0     음식점-중국음식  서울특별시   강남구     논현동     5\n",
       "28     20190901  일    0     음식점-중국음식  서울특별시   강남구     삼성동     5\n",
       "29     20190901  일    0     음식점-중국음식  서울특별시   강동구     상일동     5\n",
       "...         ... ..  ...          ...    ...   ...     ...   ...\n",
       "90038  20190930  월   23           치킨  서울특별시   송파구     송파동    17\n",
       "90039  20190930  월   23           치킨  서울특별시   양천구     신월동     5\n",
       "90040  20190930  월   23           치킨  서울특별시   양천구     신정동     5\n",
       "90041  20190930  월   23           치킨  서울특별시  영등포구   문래동3가    11\n",
       "90042  20190930  월   23           치킨  서울특별시  영등포구    여의도동     9\n",
       "90043  20190930  월   23           치킨  서울특별시   용산구    동빙고동     5\n",
       "90044  20190930  월   23           치킨  서울특별시   용산구   한강로2가     5\n",
       "90045  20190930  월   23           치킨  서울특별시   은평구     불광동     8\n",
       "90046  20190930  월   23           치킨  서울특별시   종로구     연지동     5\n",
       "90047  20190930  월   23           치킨  서울특별시    중구  남대문로5가     5\n",
       "90048  20190930  월   23           치킨  서울특별시    중구     수하동     5\n",
       "90049  20190930  월   23           치킨  서울특별시    중구     신당동    11\n",
       "90050  20190930  월   23           치킨  서울특별시    중구   장충동2가     5\n",
       "90051  20190930  월   23           치킨  서울특별시    중구   충무로4가     5\n",
       "90052  20190930  월   23           치킨  서울특별시   중랑구     면목동     7\n",
       "90053  20190930  월   23           피자  서울특별시   강남구     삼성동     5\n",
       "90054  20190930  월   23           피자  서울특별시   강남구     역삼동     5\n",
       "90055  20190930  월   23           피자  서울특별시   강동구     성내동     5\n",
       "90056  20190930  월   23           피자  서울특별시   강북구     미아동     5\n",
       "90057  20190930  월   23           피자  서울특별시   강서구    내발산동     5\n",
       "90058  20190930  월   23           피자  서울특별시   관악구     봉천동     5\n",
       "90059  20190930  월   23           피자  서울특별시   관악구     신림동     5\n",
       "90060  20190930  월   23           피자  서울특별시   광진구     중곡동     5\n",
       "90061  20190930  월   23           피자  서울특별시   구로구     개봉동     5\n",
       "90062  20190930  월   23           피자  서울특별시   마포구     상암동     5\n",
       "90063  20190930  월   23           피자  서울특별시   서초구     양재동     5\n",
       "90064  20190930  월   23           피자  서울특별시   성북구   동선동2가     5\n",
       "90065  20190930  월   23           피자  서울특별시   송파구     가락동     5\n",
       "90066  20190930  월   23           피자  서울특별시  영등포구  영등포동5가     5\n",
       "90067  20190930  월   23           피자  서울특별시   중랑구     면목동     5\n",
       "\n",
       "[90068 rows x 8 columns]"
      ]
     },
     "execution_count": 34,
     "metadata": {},
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "  </tbody>\n",
       "</table>\n",
       "<p>90068 rows × 4 columns</p>\n",
       "</div>"
      ],
      "text/plain": [
       "             일자  시간대           업종  통화건수\n",
       "0      20190901    0  음식점-족발/보쌈전문     5\n",
       "1      20190901    0  음식점-족발/보쌈전문     5\n",
       "2      20190901    0  음식점-족발/보쌈전문     5\n",
       "3      20190901    0  음식점-족발/보쌈전문     5\n",
       "4      20190901    0  음식점-족발/보쌈전문     5\n",
       "5      20190901    0  음식점-족발/보쌈전문     5\n",
       "6      20190901    0  음식점-족발/보쌈전문     5\n",
       "7      20190901    0  음식점-족발/보쌈전문     5\n",
       "8      20190901    0  음식점-족발/보쌈전문     5\n",
       "9      20190901    0  음식점-족발/보쌈전문     6\n",
       "10     20190901    0  음식점-족발/보쌈전문     5\n",
       "11     20190901    0  음식점-족발/보쌈전문     5\n",
       "12     20190901    0  음식점-족발/보쌈전문     5\n",
       "13     20190901    0  음식점-족발/보쌈전문     5\n",
       "14     20190901    0     음식점-중국음식     5\n",
       "15     20190901    0     음식점-중국음식     5\n",
       "16     20190901    0     음식점-중국음식     5\n",
       "17     20190901    0     음식점-중국음식     5\n",
       "18     20190901    0     음식점-중국음식     5\n",
       "19     20190901    0     음식점-중국음식     5\n",
       "20     20190901    0     음식점-중국음식     5\n",
       "21     20190901    0     음식점-중국음식     5\n",
       "22     20190901    0     음식점-중국음식     5\n",
       "23     20190901    0     음식점-중국음식     5\n",
       "24     20190901    0     음식점-중국음식     5\n",
       "25     20190901    0     음식점-중국음식     5\n",
       "26     20190901    0     음식점-중국음식     5\n",
       "27     20190901    0     음식점-중국음식     5\n",
       "28     20190901    0     음식점-중국음식     5\n",
       "29     20190901    0     음식점-중국음식     5\n",
       "...         ...  ...          ...   ...\n",
       "90038  20190930   23           치킨    17\n",
       "90039  20190930   23           치킨     5\n",
       "90040  20190930   23           치킨     5\n",
       "90041  20190930   23           치킨    11\n",
       "90042  20190930   23           치킨     9\n",
       "90043  20190930   23           치킨     5\n",
       "90044  20190930   23           치킨     5\n",
       "90045  20190930   23           치킨     8\n",
       "90046  20190930   23           치킨     5\n",
       "90047  20190930   23           치킨     5\n",
       "90048  20190930   23           치킨     5\n",
       "90049  20190930   23           치킨    11\n",
       "90050  20190930   23           치킨     5\n",
       "90051  20190930   23           치킨     5\n",
       "90052  20190930   23           치킨     7\n",
       "90053  20190930   23           피자     5\n",
       "90054  20190930   23           피자     5\n",
       "90055  20190930   23           피자     5\n",
       "90056  20190930   23           피자     5\n",
       "90057  20190930   23           피자     5\n",
       "90058  20190930   23           피자     5\n",
       "90059  20190930   23           피자     5\n",
       "90060  20190930   23           피자     5\n",
       "90061  20190930   23           피자     5\n",
       "90062  20190930   23           피자     5\n",
       "90063  20190930   23           피자     5\n",
       "90064  20190930   23           피자     5\n",
       "90065  20190930   23           피자     5\n",
       "90066  20190930   23           피자     5\n",
       "90067  20190930   23           피자     5\n",
       "\n",
       "[90068 rows x 4 columns]"
      ]
     },
     "execution_count": 35,
     "metadata": {},
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       ...
       "               치킨              392\n",
       "               피자               75\n",
       "Name: 통화건수, Length: 8433, dtype: int64"
      ]
     },
     "execution_count": 37,
     "metadata": {},
   ...
   "source": [
    "day = df123.groupby(['일자', '시간대', '업종']).sum()['통화건수']\n",
    "day"
   ]
  },
  {
   ...
   "outputs": [],
   "source": [
    "day.to_csv('delivery_statistic.csv', header=None, sep=\",\", line_terminator=\"\\n\", index=False, columns=['일자', '시간대', '업종', '통화건수'], mode=\"w\")"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "day_by = df123.groupby('시간대').sum()['통화건수'].reset_index(name=\"통화건수 합\")\n",
    "day_by"
   ]
  },
  {
   ...
   "outputs": [],
   "source": [
    "day_by = df123.groupby(['시간대','업종']).sum()['통화건수'].reset_index(name=\"통화건수 합\")\n",
    "day_by\n",
    "day_by.to_csv('del.csv', header=None, sep=\",\", line_terminator=\"\\n\", index=False, columns=['시간대', '업종', '통화건수 합'], mode=\"w\")"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "time_delivery = df123.groupby('시간대').sum()['통화건수'].reset_index(name=\"통화건수 합\")\n",
    "time_delivery\n",
    "time_delivery.to_csv('del_time.csv', header=None, sep=\",\", line_terminator=\"\\n\", index=False, columns=['시간대', '통화건수 합'], mode=\"w\")"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "\n",
    "# make up some data\n",
    "x = list(time_delivery['시간대'])\n",
    "y = list(time_delivery['통화건수 합'])\n",
    "\n",
    "# plot\n",
    "plt.plot(x,y)\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "food_delivery = df123.groupby('업종').sum()['통화건수'].reset_index(name=\"통화건수 합\")\n",
    "food_delivery\n",
    "food_delivery.to_csv('del_food.csv', header=None, sep=\",\", line_terminator=\"\\n\", index=False, columns=['업종', '통화건수 합'], mode=\"w\")"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "cf.go_offline()\n",
    "d = pd.read_csv(\"del.csv\", header=None, names=['시간대', '업종', '통화건수'])\n"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/html": [
       ...
       "        \n",
       "        \n",
       "            <div id=\"a3c160c1-f09a-4c0a-94a3-373f6b215ba4\" class=\"plotly-graph-div\" style=\"height:2000px; width:1200px;\"></div>\n",
       "            <script type=\"text/javascript\">\n",
       "                require([\"plotly\"], function(Plotly) {\n",
       "                    window.PLOTLYENV=window.PLOTLYENV || {};\n",
       "                    \n",
       "                if (document.getElementById(\"a3c160c1-f09a-4c0a-94a3-373f6b215ba4\")) {\n",
       "                    Plotly.newPlot(\n",
       "                        'a3c160c1-f09a-4c0a-94a3-373f6b215ba4',\n",
       ...
       "                    ).then(function(){\n",
       "                            \n",
       "var gd = document.getElementById('a3c160c1-f09a-4c0a-94a3-373f6b215ba4');\n",
   ...
   "source": [
    ...
    ")\n",
    "\n",
    "v= d.groupby('시간대').size().reset_index(name=\"통화건수\")\n",
    "time = list(v['시간대'])\n",
    "\n",
    "\n",
    "row = 1\n",
  ...
  },
  {
   ...
   "source": [
    "dt = pd.read_csv(\"del_time.csv\", header=None, names=['시간대', '통화건수 합'])\n",
    "dt"
   ]
  },
  {
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/html": [
       ...
       "        \n",
       "        \n",
       "            <div id=\"c94ae1c6-9c36-4fd8-8977-035a39e953b4\" class=\"plotly-graph-div\" style=\"height:525px; width:100%;\"></div>\n",
       "            <script type=\"text/javascript\">\n",
       "                require([\"plotly\"], function(Plotly) {\n",
       "                    window.PLOTLYENV=window.PLOTLYENV || {};\n",
       "                    \n",
       "                if (document.getElementById(\"c94ae1c6-9c36-4fd8-8977-035a39e953b4\")) {\n",
       "                    Plotly.newPlot(\n",
       "                        'c94ae1c6-9c36-4fd8-8977-035a39e953b4',\n",
       ...
       "                    ).then(function(){\n",
       "                            \n",
       "var gd = document.getElementById('c94ae1c6-9c36-4fd8-8977-035a39e953b4');\n",
       "var x = new MutationObserver(function (mutations, observer) {{\n",
       "        var display = window.getComputedStyle(gd).display;\n",
       "        if (!display || display === 'none') {{\n",
       "            console.log([gd, 'removed!']);\n",
